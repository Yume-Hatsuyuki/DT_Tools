...
{
    /// <summary>
    /// /restore_power — 强制恢复全场电力（仅房主、仅生存阶段）。
    ///
    ...
    /// </summary>
    internal sealed class RestorePowerCommand : ICommand
    {
        ...
        public CommandResult Execute(CommandContext ctx) => PowerLogic.RestorePower(ctx);
    }
}
