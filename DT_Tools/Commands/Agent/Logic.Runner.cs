...
namespace DT_Tools.Commands.Agent
{
    ...
    ///     即无条件 CreateAndDropItem + Broadcast(S_SPAWN_DEVICE)（0.1.15b Server.Game/Mineral.cs:26/43）；
    ...
    internal sealed class AgentRunner : MonoBehaviour
    {
        ...
        /// GameManagerEX.Clear() 整体置 null（0.1.15b GameManagerEX.cs:280，Managers.Clear() 调用链），
        ...
        ///     依据 1：Server.Game/ItemManager.cs InsertInven（0.1.15b:101）在 Hand 非空时会强制
